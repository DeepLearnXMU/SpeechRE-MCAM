    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def forward(self, x, encoder_padding_mask: Optional[Tensor], attn_mask: Optional[Tensor] = None):
        ...
        if attn_mask is not None:
            attn_mask = attn_mask * -1e5
            need_weights = True
            # attn_mask = attn_mask.masked_fill(attn_mask.to(torch.bool), -1e5)
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def compression_forward(
        ...
        x, attn = self.self_attn(
            ...
            key=encoder_out,    # x
            value=encoder_out,          # x,
            key_padding_mask=encoder_padding_mask,       #self_attn_padding_mask,
            incremental_state=incremental_state, # None
            need_weights=False,
