...
class BARTModel(TransformerModel):
        ...
        if classification_head_name is not None:
            ...
            for k, head in self.classification_heads.items():
                ...
                if k == classification_head_name:
                    ...
                    break
        return (x, encoder_out['encoder_out'][-1]), extra
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        (x["args"].bpe)['gpt2_encoder_json'] = model_name_or_path + "/encoder.json"
        (x["args"].bpe)['gpt2_vocab_bpe'] = model_name_or_path + "/vocab.bpe"
